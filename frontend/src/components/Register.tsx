...
export const Register = ({ onSuccess, onClose, onSwitchToLogin }: RegisterProps) => {
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4" onClick={onClose}>
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-sm" onClick={e => e.stopPropagation()}>
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          Já tens conta?{' '}
          <span className="text-green-700 font-medium cursor-pointer hover:underline" onClick={onSwitchToLogin}>
            Entrar
          </span>
        </p>
      </div>
